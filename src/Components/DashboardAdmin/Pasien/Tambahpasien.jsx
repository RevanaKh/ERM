      ...
      <div tabIndex="-1" aria-hidden="true" className={`fixed inset-0 bg-black bg-opacity-40 z-50 flex items-center justify-center ${modaltambah ? 'flex' : 'hidden'}`}>
        <div className="bg-white p-6 rounded-lg w-full max-w-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            />
            <input type="date" name="tanggal_lahir" value={tanggal_lahir} onChange={handleChange} required className="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400rounded" />
