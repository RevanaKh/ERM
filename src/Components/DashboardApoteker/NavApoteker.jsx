...
import { FaBars, FaHome, FaUsers, FaUserCircle, FaClipboardCheck } from 'react-icons/fa';
...
>
        <div className="h-full flex flex-col px-3 py-4 overflow-y-auto bg-[#1DE9B6]">
          <ul className="space-y-2 font-medium">
            ...
            <li>
              <Link to={'/dashboardApoteker/profile'} className="flex items-center p-2 text-gray-900 rounded-lg hover:text-white hover:bg-[#00B686] ">
                <FaUserCircle />
                <span className="flex-1 ms-3 whitespace-nowrap">Profile</span>
              </Link>
            </li>
            <li>
              <Link to={'/dashboardApoteker/Pendaftaran'} className="flex items-center p-2 text-gray-900 rounded-lg hover:text-white hover:bg-[#00B686] ">
                <FaClipboardCheck />
                <span className="flex-1 ms-3 whitespace-nowrap">Pendaftaran Selesai</span>
              </Link>
            </li>
            <li>
              <Link to={'/dashboardApoteker/dataobat'} className="flex items-center p-2 text-gray-900 rounded-lg  hover:text-white hover:bg-[#00B686] ">
                <BsCapsule />
